...
export function GracefulError({ error, reset }: GracefulErrorProps) {
  ...
  const errorMessages: Record<number, { title: string; description: string }> = {
    ...
    402: {
      ...
      description: "You've used up your credits. Time to upgrade your plan!"
    },
    429: {
    ...
    <div className="min-h-[400px] flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        <div className="text-center">
          ...
          {error.digest && <p className="text-xs text-gray-500 dark:text-gray-500 mb-6">Error ID: {error.digest}</p>}
