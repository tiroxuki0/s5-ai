      ...
      <div className="flex-1 flex flex-col relative">
        ...
        >
          <div className="max-w-4xl mx-auto space-y-6 pb-8">
                                ...
                                {messageSources.map((result, idx) => (
                                  ...
                                  >
                                    ...
                                    <div className="relative p-3 flex flex-col justify-between h-full">
                                      ...
                                      {/* Character count */}
                                      <div className="mt-1">
                                        <CharacterCounter targetCount={result.markdown?.length || result.content?.length || 0} duration={2000} />
                                      </div>
                                    </div>
                                  </a>
                                ))}
                          ...
                          <div>
                            <div className="flex items-center justify-between mb-3">
                              ...
                              <div className="flex items-center gap-1">
                                ...
                                >
                                  {copiedMessageId === `message-${pairIndex}` ? <Check className="h-3.5 w-3.5 text-green-500" /> : <Copy className="h-3.5 w-3.5" />}
                                </button>
                              </div>
                            </div>
                                ...
                                {messageFollowUpQuestions.map((question, qIndex) => (
                                  ...
                                  >
                                    <div className="flex items-start gap-2">
                                      ...
                                      <span className="text-sm text-gray-700 dark:text-gray-300 group-hover:text-orange-600 dark:group-hover:text-orange-400 break-words">{question}</span>
                                    </div>
                                  </button>
                                ))}
                              </div>
                        ...
                        >
                          ...
                          <div className="relative p-3 flex flex-col justify-between h-full">
                            ...
                            <div className="flex items-center gap-1.5">
                              ...
                              <p className="text-[10px] text-gray-600 dark:text-gray-300 truncate flex-1 font-medium">{result.siteName || new URL(result.url).hostname.replace("www.", "")}</p>
                            </div>
                ...
                <div className="flex items-center justify-between mb-3">
                  ...
                  {!isLoading && (
                    <div className="flex items-center gap-1 opacity-0 animate-fade-in [animation-duration:300ms] [animation-delay:200ms] [animation-fill-mode:forwards]">
                      ...
                      >
                        {copiedMessageId === "current-message" ? <Check className="h-3.5 w-3.5 text-green-500" /> : <Copy className="h-3.5 w-3.5" />}
                      </button>
                      <button
            ...
            {((isLoading && messages[messages.length - 1]?.role === "user") || isWaitingForResponse) && (
              <div className="opacity-0 animate-fade-up [animation-duration:500ms] [animation-fill-mode:forwards]">
                  ...
                  {followUpQuestions.map((question, index) => (
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-gray-700 dark:text-gray-300 group-hover:text-orange-600 dark:group-hover:text-orange-400">{question}</span>
                      </div>
                    </button>
                  ))}
                </div>
                  ...
                  >
                    <div className="w-[48px] h-[32px] flex items-center justify-center">
                      {isLoading ? (
                        ...
                        <svg fill="none" height="18" viewBox="0 0 20 20" width="18" xmlns="http://www.w3.org/2000/svg" className="text-white">
                          <path
